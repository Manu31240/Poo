...
import fr.vt.monopoly.modele.cases.proprietes.CaseCompagnie;
import fr.vt.monopoly.modele.cases.proprietes.CaseGare;
import fr.vt.monopoly.modele.cases.proprietes.CaseLot;
import fr.vt.monopoly.modele.cases.utils.InfoCases;
...
//	private final static int PRIX_ACHAT_COMPAGNIE = 150;
	...
	public Plateau() {
		...
		for (int i = 0; i < NB_CASES; i++) {
			...
			case 25:
			case 35:
				InfoCases gare = InfoCases.getConfigs().get(i);
				cases[i] = new CaseGare(gare.getNom(), gare.getPrixAchat());
				break;
			case 12:
			case 28:
				InfoCases compagnie = InfoCases.getConfigs().get(i);
				cases[i] = new CaseCompagnie(compagnie.getNom(),
						compagnie.getPrixAchat());
				break;
			case 1:
			case 3:
			case 6:
			...
			case 37:
			case 39:
				InfoCases lot = InfoCases.getConfigs().get(i);
				cases[i] = new CaseLot(lot.getNom(), lot.getPrixAchat(),
						lot.getIndice());
				break;
			default:
