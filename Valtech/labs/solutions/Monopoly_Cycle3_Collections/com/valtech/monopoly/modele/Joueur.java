...
public final class Joueur {
	...
	public void aTonTour(De d1, De d2) {
		 ...
		 */
		System.out.println(pion + " a fait " + (d1.getFace() + d2.getFace()));
		...
		position = position.getSuivante();
		position.arreterSur(this, d1, d2);
		...
		if (d1.getFace() == d2.getFace()) {
			System.out.println(pion + " a fait un double (" + d1.getFace() + "/" + d2.getFace() + ") - il rejoue !!");
			aTonTour(d1, d2);
		}
	}
